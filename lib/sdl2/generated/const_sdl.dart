...
const SDL_AUDIO_PLAYING = 0;
const SDL_AUDIO_PAUSED = 0;
...
const SDL_APP_TERMINATING = 0x100;
const SDL_APP_LOWMEMORY = 0x100;
const SDL_APP_WILLENTERBACKGROUND = 0x100;
const SDL_APP_DIDENTERBACKGROUND = 0x100;
const SDL_APP_WILLENTERFOREGROUND = 0x100;
const SDL_APP_DIDENTERFOREGROUND = 0x100;
const SDL_LOCALECHANGED = 0x100;
const SDL_DISPLAYEVENT = 0x150;
const SDL_WINDOWEVENT = 0x200;
const SDL_SYSWMEVENT = 0x200;
const SDL_KEYDOWN = 0x300;
const SDL_KEYUP = 0x300;
const SDL_TEXTEDITING = 0x300;
const SDL_TEXTINPUT = 0x300;
const SDL_KEYMAPCHANGED = 0x300;
const SDL_TEXTEDITING_EXT = 0x300;
const SDL_MOUSEMOTION = 0x400;
const SDL_MOUSEBUTTONDOWN = 0x400;
const SDL_MOUSEBUTTONUP = 0x400;
const SDL_MOUSEWHEEL = 0x400;
const SDL_JOYAXISMOTION = 0x600;
const SDL_JOYBALLMOTION = 0x600;
const SDL_JOYHATMOTION = 0x600;
const SDL_JOYBUTTONDOWN = 0x600;
const SDL_JOYBUTTONUP = 0x600;
const SDL_JOYDEVICEADDED = 0x600;
const SDL_JOYDEVICEREMOVED = 0x600;
const SDL_JOYBATTERYUPDATED = 0x600;
const SDL_CONTROLLERAXISMOTION = 0x650;
const SDL_CONTROLLERBUTTONDOWN = 0x650;
const SDL_CONTROLLERBUTTONUP = 0x650;
const SDL_CONTROLLERDEVICEADDED = 0x650;
const SDL_CONTROLLERDEVICEREMOVED = 0x650;
const SDL_CONTROLLERDEVICEREMAPPED = 0x650;
const SDL_CONTROLLERTOUCHPADDOWN = 0x650;
const SDL_CONTROLLERTOUCHPADMOTION = 0x650;
const SDL_CONTROLLERTOUCHPADUP = 0x650;
const SDL_CONTROLLERSENSORUPDATE = 0x650;
const SDL_FINGERDOWN = 0x700;
const SDL_FINGERUP = 0x700;
const SDL_FINGERMOTION = 0x700;
const SDL_DOLLARGESTURE = 0x800;
const SDL_DOLLARRECORD = 0x800;
const SDL_MULTIGESTURE = 0x800;
const SDL_CLIPBOARDUPDATE = 0x900;
const SDL_DROPFILE = 0x1000;
const SDL_DROPTEXT = 0x1000;
const SDL_DROPBEGIN = 0x1000;
const SDL_DROPCOMPLETE = 0x1000;
const SDL_AUDIODEVICEADDED = 0x1100;
const SDL_AUDIODEVICEREMOVED = 0x1100;
const SDL_SENSORUPDATE = 0x1200;
const SDL_RENDER_TARGETS_RESET = 0x2000;
const SDL_RENDER_DEVICE_RESET = 0x2000;
...
const SDL_CONTROLLER_TYPE_XBOX360 = 0;
const SDL_CONTROLLER_TYPE_XBOXONE = 0;
const SDL_CONTROLLER_TYPE_PS3 = 0;
const SDL_CONTROLLER_TYPE_PS4 = 0;
const SDL_CONTROLLER_TYPE_NINTENDO_SWITCH_PRO = 0;
const SDL_CONTROLLER_TYPE_VIRTUAL = 0;
const SDL_CONTROLLER_TYPE_PS5 = 0;
const SDL_CONTROLLER_TYPE_AMAZON_LUNA = 0;
const SDL_CONTROLLER_TYPE_GOOGLE_STADIA = 0;
const SDL_CONTROLLER_TYPE_NVIDIA_SHIELD = 0;
const SDL_CONTROLLER_TYPE_NINTENDO_SWITCH_JOYCON_LEFT = 0;
const SDL_CONTROLLER_TYPE_NINTENDO_SWITCH_JOYCON_RIGHT = 0;
const SDL_CONTROLLER_TYPE_NINTENDO_SWITCH_JOYCON_PAIR = 0;
const SDL_CONTROLLER_BINDTYPE_NONE = 0;
const SDL_CONTROLLER_BINDTYPE_BUTTON = 0;
const SDL_CONTROLLER_BINDTYPE_AXIS = 0;
const SDL_CONTROLLER_BINDTYPE_HAT = 0;
...
const SDL_CONTROLLER_AXIS_LEFTX = -1;
const SDL_CONTROLLER_AXIS_LEFTY = -1;
const SDL_CONTROLLER_AXIS_RIGHTX = -1;
const SDL_CONTROLLER_AXIS_RIGHTY = -1;
const SDL_CONTROLLER_AXIS_TRIGGERLEFT = -1;
const SDL_CONTROLLER_AXIS_TRIGGERRIGHT = -1;
const SDL_CONTROLLER_AXIS_MAX = -1;
const SDL_CONTROLLER_BUTTON_INVALID = -1;
const SDL_CONTROLLER_BUTTON_A = -1;
const SDL_CONTROLLER_BUTTON_B = -1;
const SDL_CONTROLLER_BUTTON_X = -1;
const SDL_CONTROLLER_BUTTON_Y = -1;
const SDL_CONTROLLER_BUTTON_BACK = -1;
const SDL_CONTROLLER_BUTTON_GUIDE = -1;
const SDL_CONTROLLER_BUTTON_START = -1;
const SDL_CONTROLLER_BUTTON_LEFTSTICK = -1;
const SDL_CONTROLLER_BUTTON_RIGHTSTICK = -1;
const SDL_CONTROLLER_BUTTON_LEFTSHOULDER = -1;
const SDL_CONTROLLER_BUTTON_RIGHTSHOULDER = -1;
const SDL_CONTROLLER_BUTTON_DPAD_UP = -1;
const SDL_CONTROLLER_BUTTON_DPAD_DOWN = -1;
const SDL_CONTROLLER_BUTTON_DPAD_LEFT = -1;
const SDL_CONTROLLER_BUTTON_DPAD_RIGHT = -1;
const SDL_CONTROLLER_BUTTON_MISC1 = -1;
const SDL_CONTROLLER_BUTTON_PADDLE1 = -1;
const SDL_CONTROLLER_BUTTON_PADDLE2 = -1;
const SDL_CONTROLLER_BUTTON_PADDLE3 = -1;
const SDL_CONTROLLER_BUTTON_PADDLE4 = -1;
const SDL_CONTROLLER_BUTTON_TOUCHPAD = -1;
const SDL_CONTROLLER_BUTTON_MAX = -1;
...
const SDL_JOYSTICK_POWER_EMPTY = -1;
const SDL_JOYSTICK_POWER_LOW = -1;
const SDL_JOYSTICK_POWER_MEDIUM = -1;
const SDL_JOYSTICK_POWER_FULL = -1;
const SDL_JOYSTICK_POWER_WIRED = -1;
const SDL_JOYSTICK_POWER_MAX = -1;
...
const SDL_LOG_PRIORITY_DEBUG = 1;
const SDL_LOG_PRIORITY_INFO = 1;
const SDL_LOG_PRIORITY_WARN = 1;
const SDL_LOG_PRIORITY_ERROR = 1;
const SDL_LOG_PRIORITY_CRITICAL = 1;
const SDL_NUM_LOG_PRIORITIES = 1;
//const SDL_main_h_ = ;
...
const SDL_SENSOR_UNKNOWN = -1;
const SDL_SENSOR_ACCEL = -1;
const SDL_SENSOR_GYRO = -1;
...
const SDL_TOUCH_DEVICE_DIRECT = -1;
const SDL_TOUCH_DEVICE_INDIRECT_ABSOLUTE = -1;
const SDL_TOUCH_DEVICE_INDIRECT_RELATIVE = -1;
